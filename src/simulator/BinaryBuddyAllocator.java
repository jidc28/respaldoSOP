...
public class BinaryBuddyAllocator {
    ...
    /**
      * Class constructor, specifying a minimum number of free pages and the 
      * size order of the memory (that is: 2^order).
      */
    ...
    /**  
     * This method looks for a free memory page block to assign to a
     * process.
     *
